...
args = {"problem":"TFIM", "params":"[1.,1.]","nrun":0, "shots":0, "epochs":500, "n_qubits":4, "vans_its":200,"itraj":1, "noisy":False, "noise_strength":0.0, "acceptange_percentage": 0.01, "L_HEA":1}
...
for vans_it in range(evaluator.vans_its):
    ...
    inserter.choose_qubit_Temperature=scheduler_selector_temperature(cost, evaluator.lowest_cost, when_on=10.0)
    mutated_db, number_mutations = inserter.mutate(circuit_db, mutation_rate=1.5)
