...
def send_vans(ns):
    ...
    os.system("{} running/tfq/HEA/main_HEA.py --run_name 'HEA' --params '{}' --n_qubits 8 --problem TFIM --itraj {} --noisy 1 --noise_strength {} ".format(get_python(),str([1.0, 1.0]), itraj, ns))
