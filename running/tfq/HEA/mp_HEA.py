...
def send_vans(ns):
    ...
    os.system("python3.8 running/tfq/HEA/main_HEA.py --params '{}' --n_qubits 4 --problem TFIM --itraj 0 --noisy 1 --noise_strength {} --vans_its 40 --L_HEA {}".format(str([1.0, 1.0]), ns, L_HEA))
