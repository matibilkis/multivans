...
cores = 15
js = list(np.logspace(-8,-5,160))

def send_vans(ns):
    for k in range(10):
        os.system("{} running/tfq/HEA/main_HEA.py --params '{}' --n_qubits 8 --lr 0.001 --L_HEA 1 --noise_strength {} --noisy 1 --itraj {} --run_name HEA_fixed".format(get_python(),str([1.0, 1.0]), ns, itraj+k))
